...
const PetProducts = () => {
  ...
  return (
    <div>
      <Navbar whichActive={"petProducts"} />
      <div className={`offWhiteBg superContainer`}>
        <div className="mainContainer">
          <Heading1 title="Pet Shops" />
          ...
          >
            ...
            <IconButton
              onClick={() => notify("Your coupon code is:  li3-ddf-4k1")}
            >
              <ToastContainer
                position="top-right"
                autoClose={5000}
          ...
          <div className="shopInfo">
            ...
            <IconButton
              onClick={() => notify("Your coupon code is:  xlk-i92-4km")}
            >
              <ToastContainer
                position="top-right"
                autoClose={5000}
          ...
          <div className="shopInfo">
            ...
            <IconButton
              onClick={() => notify("Your coupon code is:  3m3-d4f-la1")}
            >
              <ToastContainer
                position="top-right"
                autoClose={5000}
          ...
          <div className="shopInfo">
            ...
            <IconButton
              onClick={() => notify("Your coupon code is:  399-dsf-lkn")}
            >
              <ToastContainer
                position="top-right"
                autoClose={5000}
